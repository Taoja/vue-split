  ...
  <t-page ref="page">
    ...
    <div>
      ...
      <t-group title="监听按钮回调">
        <t-cell title="自定义按钮" isLink @click="base2({title: '标题', msg: '内容文字',okButton: '确认', cancelButton: '取消', extendBtns: [{key: '自定义1', value: '1', color: 'blue'},{key: '自定义2', value: '2', color: 'yellow'}]})"></t-cell>
      </t-group>
      <t-group title="引入用法">
